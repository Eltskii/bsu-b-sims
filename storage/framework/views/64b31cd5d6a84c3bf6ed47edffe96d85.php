...
<head>
    ...
    <title>Admin Login - <?php echo e(config('app.name', 'BSU-Bokod SIMS')); ?></title>
                ...
                <form method="POST" action="<?php echo e(route('admin.login.post')); ?>">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <?php if(Route::has('password.request')): ?>
                            <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-primary hover:text-indigo-700 font-medium">
                                Forgot password?
                            </a>
                        <?php endif; ?>
                    </div>
...
<?php /**PATH /opt/lampp/htdocs/bsu-sims/resources/views/auth/admin-login.blade.php ENDPATH**/ ?>
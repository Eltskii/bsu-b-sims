...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Programs <?php $__env->endSlot(); ?>
    <div class="py-8">
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($totalEnrollment); ?></p>
                            </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($inactivePrograms); ?></p>
                            </div>
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    <div class="text-sm font-semibold text-gray-900"><?php echo e($program->name); ?></div>
                                                    <?php if($program->description): ?>
                                                        <div class="text-xs text-gray-500 mt-0.5 truncate max-w-md"><?php echo e(Str::limit($program->description, 60)); ?></div>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900"><?php echo e($program->department?->name ?? '-'); ?></div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <div class="inline-flex items-center px-3 py-1 bg-purple-100 rounded-lg">
                                                ...
                                                <span class="text-sm font-semibold text-purple-800"><?php echo e($program->students_count); ?></span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <div class="flex items-center justify-center gap-2">
                                                ...
                                                <?php if($program->students_count == 0): ?>
                                                    <form action="<?php echo e(route('programs.destroy', $program)); ?>" method="POST" class="inline" onsubmit="return confirm('⚠️ Are you sure you want to delete this program?\n\nThis action cannot be undone.');">
                                                        <?php echo csrf_field(); ?>
                                    ...
                                    <tr>
                                        <td colspan="6" class="px-6 py-12 text-center">
                                            <div class="flex flex-col items-center justify-center">
                                                ...
                                                <a href="<?php echo e(route('programs.create')); ?>" class="inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg transition-colors duration-200">
                                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                                                    </svg>
                                                    Add Program
...
<?php endif; ?>
<?php /**PATH /opt/lampp/htdocs/bsu-sims/resources/views/programs/index.blade.php ENDPATH**/ ?>
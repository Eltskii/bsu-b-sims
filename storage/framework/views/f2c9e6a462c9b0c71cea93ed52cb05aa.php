...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Student Archives <?php $__env->endSlot(); ?>
                ...
                <div class="p-6 text-gray-900">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <?php $__currentLoopData = $archives; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $archive): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="archive-card group bg-white border border-gray-200 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 hover:border-indigo-300">
                                    ...
                                    <h4 class="text-2xl font-bold text-gray-900 mb-2 group-hover:text-indigo-600 transition-colors"><?php echo e($archive->archived_school_year); ?></h4>
                                    <p class="text-base text-gray-600 mb-4 font-medium"><?php echo e($archive->archived_semester); ?></p>
                                    ...
                                    <div class="flex items-center bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl px-4 py-3 mb-6">
                                        ...
                                        <div>
                                            <p class="text-2xl font-bold text-indigo-600"><?php echo e($archive->total_students); ?></p>
                                            <p class="text-xs text-gray-600 font-medium">Archived Students</p>
                                        </div>
                                    </div>

                                    <div class="flex gap-3">
                                        <a href="<?php echo e(route('archive.show', [$archive->archived_school_year, $archive->archived_semester])); ?>" 
                                        ...
                                        <form action="<?php echo e(route('archive.destroy', [$archive->archived_school_year, $archive->archived_semester])); ?>" 
                                              method="POST" 
                    ...
                    <?php else: ?>
                        <div class="text-center py-12">
                            ...
                            <a href="<?php echo e(route('archive.create')); ?>" class="inline-flex items-center bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-xl shadow-lg transition-all duration-300">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                                </svg>
...
<?php endif; ?>
<?php /**PATH /opt/lampp/htdocs/bsu-sims/resources/views/archive/index.blade.php ENDPATH**/ ?>
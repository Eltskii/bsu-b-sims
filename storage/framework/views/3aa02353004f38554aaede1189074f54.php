...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Import Batches <?php $__env->endSlot(); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    <?php echo e(__('Grade Import Batches')); ?>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div class="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-purple-600">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-gray-900"><?php echo e($batches->total()); ?></h3>
                        </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-amber-600">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-gray-900"><?php echo e($batches->whereIn('status', ['pending', 'ready', 'submitted'])->count()); ?></h3>
                        </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-emerald-600">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-gray-900"><?php echo e($batches->where('status', 'approved')->count()); ?></h3>
                        </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-red-600">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-semibold text-gray-600 uppercase tracking-wide mb-2">Rejected</p>
                            <h3 class="text-3xl font-bold text-gray-900"><?php echo e($batches->where('status', 'rejected')->count()); ?></h3>
                        </div>
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="px-6 py-4 text-sm">
                                            <div class="flex items-center">
                                                ...
                                                <span class="font-medium text-gray-900"><?php echo e($batch->file_name); ?></span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                                            <span class="font-semibold text-gray-900"><?php echo e($batch->total_records); ?></span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                                            <div class="flex items-center justify-center gap-2">
                                                <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-emerald-100 text-emerald-800">
                                                    ...
                                                    <?php echo e($batch->success_count); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm">
                                            <div class="flex items-center justify-center gap-2">
                                                <a href="<?php echo e(route('chairperson.grade-batches.show', $batch)); ?>" 
                                    ...
                                    <tr>
                                        <td colspan="6" class="px-6 py-16">
                                            <div class="text-center">
                                                ...
                                                <a href="<?php echo e(route('chairperson.grade-import.create')); ?>" class="inline-flex items-center px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-all shadow-sm hover:shadow-md">
...
<?php endif; ?>
<?php /**PATH /opt/lampp/htdocs/bsu-sims/resources/views/chairperson/grades/batches/index.blade.php ENDPATH**/ ?>
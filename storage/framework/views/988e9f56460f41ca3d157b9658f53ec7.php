...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Chairperson Dashboard <?php $__env->endSlot(); ?>
    <div class="py-8">
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-indigo-600 group">
                    <div class="flex items-start justify-between mb-4">
                        <div>
                            ...
                            <h3 class="text-4xl font-bold text-gray-900"><?php echo e($totalStudents); ?></h3>
                        </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-amber-600 group">
                    <div class="flex items-start justify-between mb-4">
                        <div>
                            ...
                            <h3 class="text-4xl font-bold text-gray-900"><?php echo e($pendingGrades); ?></h3>
                        </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-emerald-600 group">
                    <div class="flex items-start justify-between mb-4">
                        <div>
                            ...
                            <h3 class="text-4xl font-bold text-gray-900"><?php echo e($completedGrades); ?></h3>
                        </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-purple-600 group">
                    <div class="flex items-start justify-between mb-4">
                        <div>
                            ...
                            <h3 class="text-4xl font-bold text-gray-900"><?php echo e($totalBatches); ?></h3>
                        </div>
                ...
                <div class="flex items-center gap-4">
                    <div class="flex-1">
                        <div class="w-full bg-gray-200 rounded-full h-8 overflow-hidden">
                            <?php if($gradeCompletionPercentage > 0): ?>
                                <div class="h-8 rounded-full bg-gradient-to-r from-indigo-500 to-indigo-600 flex items-center justify-center text-white text-sm font-bold transition-all duration-500"
                                     style="width: <?php echo e($gradeCompletionPercentage); ?>%">
                                    <?php echo e($gradeCompletionPercentage); ?>%
                                </div>
                            <?php else: ?>
                    ...
                    <div class="text-right">
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($completedGrades); ?>/<?php echo e($pendingGrades + $completedGrades); ?></p>
                            ...
                            <?php $__currentLoopData = $subjectsWithStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div>
                                    <div class="flex justify-between items-center mb-1">
                                        <span class="text-sm font-semibold text-gray-700"><?php echo e($subject->code); ?> - <?php echo e($subject->name); ?></span>
                                        <span class="text-sm font-bold text-gray-900"><?php echo e($subject->completion_percentage); ?>%</span>
                                    </div>
                                    <div class="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                                        <div class="h-3 rounded-full transition-all duration-500 <?php echo e($subject->completion_percentage >= 80 ? 'bg-emerald-500' : ($subject->completion_percentage >= 50 ? 'bg-amber-500' : 'bg-red-500')); ?>"
                                             style="width: <?php echo e($subject->completion_percentage); ?>%">
                                        </div>
                                    </div>
                                    <p class="text-xs text-gray-500 mt-1"><?php echo e($subject->pending_grades); ?> pending out of <?php echo e($subject->total_enrollments); ?> total</p>
                                </div>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <a href="<?php echo e(route('chairperson.grades.index')); ?>" class="group bg-gradient-to-br from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                    ...
                    <a href="<?php echo e(route('chairperson.grade-import.create')); ?>" class="group bg-gradient-to-br from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                        <div class="flex items-start space-x-4">
                            <div class="p-3 bg-white/20 backdrop-blur-sm group-hover:bg-white/30 rounded-lg transition-all">
                                <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="<?php echo e(route('chairperson.grade-batches.index')); ?>" class="group bg-gradient-to-br from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                        <div class="flex items-start space-x-4">
                            <div class="p-3 bg-white/20 backdrop-blur-sm group-hover:bg-white/30 rounded-lg transition-all">
                                <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                        ...
                        <?php $__currentLoopData = $recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="py-4 hover:bg-gray-50 -mx-6 px-6 transition-colors">
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        <p class="text-base font-medium text-gray-800"><?php echo e($activity->description); ?></p>
    ...
    <script>
        ...
        const batchStatusData = <?php echo json_encode($batchStatusData, 15, 512) ?>;
...
<?php endif; ?>
<?php /**PATH /opt/lampp/htdocs/bsu-sims/resources/views/chairperson/dashboard.blade.php ENDPATH**/ ?>
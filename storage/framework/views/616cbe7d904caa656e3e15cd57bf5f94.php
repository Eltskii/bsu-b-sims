...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo $__env->yieldContent('title', 'Student Portal'); ?> - <?php echo e(config('app.name', 'BSU-Bokod SIMS')); ?></title>
                ...
                <div class="px-4 sm:px-6 lg:px-8">
                    <div class="flex items-center justify-between h-16">
                        ...
                        <div class="shrink-0 flex items-center relative z-10">
                            <a href="<?php echo e(route('student.dashboard')); ?>" class="flex items-center gap-3 group">
                                <?php if(file_exists(public_path('images/bsu-logo.png'))): ?>
                                    <img src="<?php echo e(asset('images/bsu-logo.png')); ?>" alt="BSU-Bokod" class="w-10 h-10 object-contain drop-shadow-lg">
                                <?php else: ?>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:gap-8">
                            ...
                            <div class="flex space-x-1 relative z-10">
                                <a href="<?php echo e(route('student.dashboard')); ?>" class="px-4 py-2 rounded-lg text-sm font-medium text-white hover:bg-white/10 hover:text-emerald-300 transition-all <?php echo e(request()->routeIs('student.dashboard') ? 'bg-white/20 text-emerald-300' : ''); ?>">
                                    Dashboard
                                </a>
                                <a href="<?php echo e(route('student.profile')); ?>" class="px-4 py-2 rounded-lg text-sm font-medium text-white hover:bg-white/10 hover:text-emerald-300 transition-all <?php echo e(request()->routeIs('student.profile') ? 'bg-white/20 text-emerald-300' : ''); ?>">
                                    Profile
                                </a>
                            </div>
                            ...
                            <div class="flex items-center gap-3 relative z-10">
                                ...
                                <div class="hidden md:block text-right">
                                    <div class="text-sm font-semibold text-white drop-shadow">
                                        <?php echo e(Auth::guard('student')->user()->student->first_name ?? 'Student'); ?> <?php echo e(Auth::guard('student')->user()->student->last_name ?? ''); ?>

                                    </div>
                                    <div class="text-xs text-emerald-300">
                                        <?php echo e(Auth::guard('student')->user()->student->student_id ?? ''); ?>

                                    </div>
                                </div>
                                
                                <form method="POST" action="<?php echo e(route('student.logout')); ?>" class="inline">
                                    <?php echo csrf_field(); ?>
...
<?php /**PATH /opt/lampp/htdocs/bsu-sims/resources/views/layouts/student.blade.php ENDPATH**/ ?>
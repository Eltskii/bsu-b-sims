...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Academic Years <?php $__env->endSlot(); ?>
    <style>
        dialog[open] {
     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2">
                ...
                <a href="<?php echo e(route('academic-years.create')); ?>" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded cursor-pointer">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $academicYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="border-b hover:bg-gray-50 transition">
                                            <td class="px-4 py-3 font-medium"><?php echo e($year->year_code); ?></td>
                                            <td class="px-4 py-3"><?php echo e($year->semester); ?></td>
                                            <td class="px-4 py-3"><?php echo e($year->start_date->format('M d, Y')); ?></td>
                                            <td class="px-4 py-3"><?php echo e($year->end_date->format('M d, Y')); ?></td>
                                            <td class="px-4 py-3">
                                                <?php if($year->registration_start_date && $year->registration_end_date): ?>
                                                    <span class="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded">
                                                        ...
                                                        ?>
                                                        <?php echo e($startDate->format('M d')); ?> - <?php echo e($endDate->format('M d')); ?>
                                            ...
                                            <td class="px-4 py-3">
                                                <div class="flex gap-2 justify-center flex-wrap">
                                                    <?php if(!$year->is_current): ?>
                                                        <form action="<?php echo e(route('academic-years.set-current', $year)); ?>" method="POST" class="inline">
                                                            <?php echo csrf_field(); ?>
                                                    ...
                                                    <?php endif; ?>
                                                    <a href="<?php echo e(route('academic-years.edit', $year)); ?>" class="text-indigo-600 hover:text-indigo-900 hover:underline text-xs font-semibold">
                                                        Edit
                                                    </a>
                                                    <form action="<?php echo e(route('academic-years.destroy', $year)); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure? This cannot be undone.');">
                                                        <?php echo csrf_field(); ?>
    ...
    <dialog id="transitionModal" class="rounded-lg shadow-2xl max-w-md w-96 p-0">
        <div class="bg-white rounded-lg p-6">
            ...
            <form method="POST" action="<?php echo e(route('semester-transition.execute')); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
                    ...
                    <select name="current_year_id" required class="w-full border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-purple-600">
                        ...
                        <?php $__currentLoopData = $academicYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($year->id); ?>">
                                <?php echo e($year->year_code); ?> (<?php echo e($year->semester); ?>)
                            </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
...
<?php endif; ?>
<?php /**PATH /opt/lampp/htdocs/bsu-sims/resources/views/academic-years/index.blade.php ENDPATH**/ ?>
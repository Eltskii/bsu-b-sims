...
<head>
    ...
    <title>Student Login - <?php echo e(config('app.name', 'BSU-Bokod SIMS')); ?></title>
...
<body class="antialiased">
    <div class="min-h-screen hero-bg flex items-center justify-center px-4 py-12 relative overflow-hidden">
        ...
        <div class="max-w-md w-full relative z-10">
            <!-- Back to Home -->
            <a href="<?php echo e(url('/')); ?>" class="inline-flex items-center text-white/80 hover:text-white mb-6 text-sm transition-colors">
            ...
            <div class="text-center mb-8">
                <?php if(file_exists(public_path('images/bsu-logo.png'))): ?>
                    <img src="<?php echo e(asset('images/bsu-logo.png')); ?>" alt="BSU-Bokod Logo" class="w-24 h-24 mx-auto mb-4 object-contain">
                <?php else: ?>
            ...
            <div class="bg-white rounded-xl shadow-2xl p-8">
                <form method="POST" action="<?php echo e(route('student.login.post')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input id="student_id" type="text" name="student_id" value="<?php echo e(old('student_id')); ?>" 
            ...
            <div class="text-center mt-6 landing-muted text-xs">
                <p>&copy; <?php echo e(date('Y')); ?> BSU-Bokod. All rights reserved.</p>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH /opt/lampp/htdocs/bsu-sims/resources/views/auth/student-login.blade.php ENDPATH**/ ?>
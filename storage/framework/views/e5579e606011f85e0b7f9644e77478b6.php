            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="group relative overflow-hidden bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100">
                    ...
                    <div class="p-8">
                        ...
                        <a href="<?php echo e(route('reports.students')); ?>" 
                ...
                <div class="group relative overflow-hidden bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100">
                    ...
                    <div class="p-8">
                        ...
                        <a href="<?php echo e(route('reports.programs')); ?>" 
                ...
                <div class="group relative overflow-hidden bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100">
                    ...
                    <div class="p-8">
                        ...
                        <a href="<?php echo e(route('reports.year-levels')); ?>" 
                ...
                <div class="group relative overflow-hidden bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100">
                    ...
                    <div class="p-8">
                        ...
                        <a href="<?php echo e(route('reports.export-students')); ?>" 
...
<?php endif; ?>
<?php /**PATH /opt/lampp/htdocs/bsu-sims/resources/views/reports/index.blade.php ENDPATH**/ ?>
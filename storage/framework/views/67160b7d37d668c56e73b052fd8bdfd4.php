...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            ...
            <a href="<?php echo e(route('users.create')); ?>" class="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-6 py-3 rounded-lg shadow-md hover:shadow-lg transition flex items-center gap-2">
                ...
                <div class="bg-gradient-to-br from-red-500 to-red-600 rounded-lg shadow-md p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold"><?php echo e($users->where('role', 'admin')->count()); ?></p>
                        </div>
                ...
                <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg shadow-md p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold"><?php echo e($users->where('role', 'chairperson')->count()); ?></p>
                        </div>
                ...
                <div class="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-lg shadow-md p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold"><?php echo e($users->count()); ?></p>
                        </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 user-table">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <template x-for="user in filteredUsers" :key="user.id">
                                    <tr class="hover:bg-gray-50 transition" :class="{ 'bg-blue-50': user.id === <?php echo e(auth()->id()); ?> }">
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-4">
                                                    <div class="text-sm font-medium text-gray-900 flex items-center gap-2">
                                                        ...
                                                        <span x-show="user.id === <?php echo e(auth()->id()); ?>" class="px-2 py-0.5 text-xs bg-blue-100 text-blue-800 rounded-full font-semibold">You</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                            <div class="flex items-center justify-center gap-2">
                                                <a :href="`<?php echo e(route('users.index')); ?>/${user.id}/edit`" class="inline-flex items-center px-3 py-1.5 bg-indigo-100 text-indigo-700 rounded-lg hover:bg-indigo-200 transition">
                                                    <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                    </svg>
                                                    Edit
                                                </a>
                                                <form x-show="user.id !== <?php echo e(auth()->id()); ?>" :action="`<?php echo e(route('users.index')); ?>/${user.id}`" method="POST" class="inline" 
...
<?php endif; ?>
<?php /**PATH /opt/lampp/htdocs/bsu-sims/resources/views/users/index.blade.php ENDPATH**/ ?>
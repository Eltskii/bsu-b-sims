        ...
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div class="flex items-center gap-4">
                <div class="w-20 h-20 rounded-full bg-white/20 flex items-center justify-center ring-4 ring-white/30">
                    <span class="text-3xl font-bold text-white"><?php echo e(strtoupper(substr($student->first_name, 0, 1))); ?></span>
                </div>
                <div>
                    <h1 class="text-3xl font-bold text-white"><?php echo e($student->first_name); ?> <?php echo e($student->last_name); ?></h1>
                    <p class="text-sm text-emerald-100 mt-1 font-medium"><?php echo e($student->student_id); ?> • <?php echo e($student->program->name ?? 'N/A'); ?></p>
                    <p class="text-xs text-emerald-200 mt-0.5"><?php echo e($student->year_level); ?> Year • <?php echo e($student->status); ?></p>
                </div>
            </div>
            <div class="text-right bg-white/10 backdrop-blur-sm rounded-xl px-6 py-4 border border-white/20">
                ...
                <?php if($overallGwa && $overallGwa > 0): ?>
                    <p class="text-4xl font-bold text-white mt-1"><?php echo e(number_format($overallGwa, 2)); ?></p>
...
<div class="bg-gray-100 min-h-screen">
    <div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-indigo-500 hover:shadow-lg transition-shadow">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($enrollmentCount); ?></p>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-emerald-500 hover:shadow-lg transition-shadow">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($completedUnits); ?></p>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-amber-500 hover:shadow-lg transition-shadow">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs font-medium text-gray-500 uppercase tracking-wide">Current Semester</p>
                        <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($currentSemesterGwa ? number_format($currentSemesterGwa, 2) : '—'); ?></p>
        ...
        <?php if($enrollmentsByYearLevel->isNotEmpty()): ?>
            <?php $__currentLoopData = $enrollmentsByYearLevel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $yearLevel => $semesters): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white rounded-lg shadow-lg overflow-hidden mb-8 border-2 border-gray-200">
                ...
                <div class="relative overflow-hidden px-8 py-5" style="background: linear-gradient(135deg, #1e40af, #1e3a8a, #312e81);">
                    ...
                    <div class="relative z-10 flex items-center justify-between">
                        <div>
                            <h2 class="text-2xl font-bold text-white"><?php echo e($yearLevel); ?></h2>
                        ...
                        <div class="text-right">
                            <p class="text-3xl font-bold text-white"><?php echo e($totalSubjects); ?></p>
                            <p class="text-sm text-blue-200"><?php echo e(Str::plural('Subject', $totalSubjects)); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 space-y-6">
                    <?php $__currentLoopData = $semesters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semesterLabel => $enrollments): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-xl overflow-hidden shadow-md border-2 border-gray-200 hover:border-emerald-400 transition-all duration-200">
                        <div class="px-6 py-4 bg-gradient-to-r from-emerald-600 to-teal-600 flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <h3 class="text-base font-semibold text-white"><?php echo e($semesterLabel); ?></h3>
                            </div>
                            <div class="flex items-center gap-2">
                                <span class="px-3 py-1 bg-white/20 rounded-full text-xs text-white font-medium"><?php echo e($enrollments->count()); ?> <?php echo e(Str::plural('subject', $enrollments->count())); ?></span>
                            </div>
                        </div>
                    ...
                    <table class="w-full bg-white rounded-lg overflow-hidden">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900"><?php echo e($enrollment->subject->code); ?></td>
                                <td class="px-6 py-4 text-sm text-gray-700 font-medium"><?php echo e($enrollment->subject->name); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-700"><?php echo e($enrollment->subject->units); ?></td>
                                    ...
                                    <?php if($enrollment->grade): ?>
                                        <?php if(is_numeric($enrollment->grade)): ?>
                                            <span class="px-3 py-1 inline-flex text-sm font-bold rounded-lg
                                                <?php if($enrollment->grade <= 1.75): ?> bg-emerald-100 text-emerald-800
                                                <?php elseif($enrollment->grade <= 2.5): ?> bg-blue-100 text-blue-800
                                                <?php elseif($enrollment->grade < 4.0): ?> bg-amber-100 text-amber-800
                                ...
                                <td class="px-6 py-4 text-sm">
                                    ...
                                    ?>
                                    <span class="<?php echo e($remarkColor); ?>">
                                        <?php echo e($remark); ?>

                                    </span>
                                    <?php if($enrollment->remarks): ?>
                                        <span class="text-xs text-gray-500 block mt-1"><?php echo e($enrollment->remarks); ?></span>
                                    <?php endif; ?>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.student', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /opt/lampp/htdocs/bsu-sims/resources/views/student/dashboard.blade.php ENDPATH**/ ?>
...
<?php $component->withAttributes([]); ?>
        ...
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-indigo-600 group">
                    <div class="flex items-start justify-between mb-4">
                        <div>
                            ...
                            <h3 class="text-4xl font-bold text-gray-900"><?php echo e($totalStudents ?? 0); ?></h3>
                        </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-emerald-600 group">
                    <div class="flex items-start justify-between mb-4">
                        <div>
                            ...
                            <h3 class="text-4xl font-bold text-gray-900"><?php echo e($activeStudents ?? 0); ?></h3>
                        </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-purple-600 group">
                    <div class="flex items-start justify-between mb-4">
                        <div>
                            ...
                            <h3 class="text-4xl font-bold text-gray-900"><?php echo e($totalPrograms ?? 0); ?></h3>
                        </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-amber-600 group">
                    <div class="flex items-start justify-between mb-4">
                        <div>
                            ...
                            <h3 class="text-4xl font-bold text-gray-900"><?php echo e($graduatedStudents ?? 0); ?></h3>
                        </div>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <a href="<?php echo e(route('students.create')); ?>" class="group bg-gradient-to-br from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                    ...
                    <a href="<?php echo e(route('students.index')); ?>" class="group bg-gradient-to-br from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                        <div class="flex items-start space-x-4">
                            <div class="p-3 bg-white/20 backdrop-blur-sm group-hover:bg-white/30 rounded-lg transition-all">
                                <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="<?php echo e(route('reports.index')); ?>" class="group bg-gradient-to-br from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                        <div class="flex items-start space-x-4">
                            <div class="p-3 bg-white/20 backdrop-blur-sm group-hover:bg-white/30 rounded-lg transition-all">
                                <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                ...
                <?php if($recentActivities->count() > 0): ?>
                                ...
                                <div class="flex items-start justify-between">
                                    ...
                                    <div class="text-right ml-4">
                                        <?php if($activity->user): ?>
                                            <p class="text-sm text-gray-500"><?php echo e($activity->user->name); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-200">
                        <a href="<?php echo e(route('activities.index')); ?>" class="text-sm text-blue-600 hover:text-blue-800 font-medium">
                            View all activity →
                        </a>
                    </div>
                <?php else: ?>
    ...
    <script>
        ...
        const programData = <?php echo json_encode($programData, 15, 512) ?>;
        ...
        const yearLevelData = <?php echo json_encode($yearLevelData, 15, 512) ?>;
...
<?php endif; ?>
<?php /**PATH /opt/lampp/htdocs/bsu-sims/resources/views/dashboard.blade.php ENDPATH**/ ?>
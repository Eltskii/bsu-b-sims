...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Programs Report <?php $__env->endSlot(); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Students by Program Report')); ?>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="mb-8">
                            <div class="bg-blue-50 border-l-4 border-blue-500 p-4 mb-3">
                                <h4 class="font-bold text-lg"><?php echo e($program->code); ?> - <?php echo e($program->name); ?></h4>
                                <p class="text-sm text-gray-600">Total Students: <?php echo e($program->students_count); ?></p>
                            </div>
                            ...
                            <?php if($program->students->count() > 0): ?>
                                <table class="min-w-full divide-y divide-gray-200 mb-4">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <?php $__currentLoopData = $program->students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                    ...
                    <div class="mt-6 pt-4 border-t text-sm text-gray-600">
                        <p><strong>Total Programs:</strong> <?php echo e($programs->count()); ?></p>
                        <p><strong>Total Students:</strong> <?php echo e($programs->sum('students_count')); ?></p>
...
<?php endif; ?>
<?php /**PATH /opt/lampp/htdocs/bsu-sims/resources/views/reports/programs.blade.php ENDPATH**/ ?>
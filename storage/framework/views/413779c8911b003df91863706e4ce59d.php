    ...
    <section class="hero-bg min-h-screen flex flex-col">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex-1 flex flex-col justify-center w-full">
            ...
            <div class="text-center mb-6">
                ...
                <div class="mb-3 animate-fade-in-up">
                    <?php if(file_exists(public_path('images/bsu-logo.png'))): ?>
                        <img src="<?php echo e(asset('images/bsu-logo.png')); ?>" alt="BSU-Bokod Logo" class="w-32 h-32 mx-auto object-contain">
                    <?php else: ?>
            ...
            <div class="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto w-full">
                <!-- Admin Portal Card -->
                <a href="<?php echo e(route('admin.login')); ?>" class="portal-card group">
                ...
                <!-- Student Portal Card -->
                <a href="<?php echo e(route('student.login')); ?>" class="portal-card group">
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="text-center pt-6 border-t border-white/10">
                    <p class="landing-muted text-xs">
                        &copy; <?php echo e(date('Y')); ?> Benguet State University - Bokod Campus. All rights reserved.
                    </p>
...
<?php /**PATH /opt/lampp/htdocs/bsu-sims/resources/views/welcome.blade.php ENDPATH**/ ?>